...
to regla-general
  ...
  if pcolor = black [
    ...
    fd 1
    ; gira para cualquier lado en el angulo de vision
    right random 130
  ]
end

to regla-equipo-A
  ;; se sale de la zona azul
  if pcolor = blue [
